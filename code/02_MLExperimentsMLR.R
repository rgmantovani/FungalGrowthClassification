...
if(!dir.exists("~/capsule/results/")) {
  dir.create("~/capsule/results/", showWarnings=FALSE, recursive=TRUE)
}

if(!dir.exists("~/capsule/results/deepLearningResults")) {
...
write.csv(as.data.frame(tmp_all),  file = "~/capsule/data/dataset/task_complete.csv")
write.csv(as.data.frame(tmp_all2), file = "~/capsule/data/dataset/task_aggregated.csv")
write.csv(as.data.frame(tmp_cor),  file = "~/capsule/data/dataset/task_color_channels.csv")
write.csv(as.data.frame(tmp_esta), file = "~/capsule/data/dataset/task_histograms.csv")
write.csv(as.data.frame(tmp_rest), file = "~/capsule/data/dataset/task_other_features.csv")
...
save(res, file = "~/capsule/results/mlr_results_complete.RData")
write.csv(perf.complete, file = "~/capsule/results/mlr_performances_complete.csv")
write.csv(perf.aggregated, file = "~/capsule/results/mlr_performances_aggregated.csv")
